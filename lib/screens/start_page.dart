...
class _StartPageState extends State<StartPage> {
  ...
  Widget build(BuildContext context) {
    var tempDisplayedDiceWords = Provider.of<DiceWords>(context);
        ...
        return Scaffold(
            ...
            children: <Widget>[
              ...
              ListTile(
                  ...
                  onTap: () {
                    setState(() {
                      Provider.of<DiceWords>(context, listen: false)
                          .copyInto(DiceWordsBuiltInArray.b[3].wordList);
                    });
                    Navigator.pop(context);
                  }),
              ListTile(
              ...
              ListTile(
                  ...
                  onTap: () {
                    setState(() {
                      Provider.of<DiceWords>(context, listen: false)
                          .copyInto(DiceWordsBuiltInArray.b[4].wordList);
                    });
          ...
          body: Container(
            ...
            child: Column(
              ...
              children: <Widget>[
                Image.asset('images/dice_animation_blue_infinite.gifv',
                    height: 80),
                Text(
                  'ADVICE DICE',
              ...
              setState(() {
                ...
                this.wheelController.animateToItem(
                    (this.wheelController.selectedItem + Random().nextInt(80)) %
                        100,
                    duration:
                        Duration(milliseconds: Random().nextInt(3000) + 1500),
...
// TODO: refactor so the wheel is a separate Widget
